...
# ۵ ثانیه، چون گرفتن تیکر ۲۴ساعته‌ی کل بازار سنگین‌تر از گرفتن فقط قیمته؛
# ولی هنوز خیلی سریع‌تر از اسکن ۱۵دقیقه‌ای قدیمیه.
GAIN_REFRESH_SECONDS = float(os.getenv("GAIN_REFRESH_SECONDS", "20.0"))
