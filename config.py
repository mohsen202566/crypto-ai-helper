...
ROLLING_OPTIMIZER_TARGET_MOVE_PERCENT = _get_float("ROLLING_OPTIMIZER_TARGET_MOVE_PERCENT", 0.75)
...
ROLLING_OPTIMIZER_MAX_END_CANDLES = _get_int("ROLLING_OPTIMIZER_MAX_END_CANDLES", 24)
...
ROLLING_OPTIMIZER_WARMUP_CANDLES = _get_int("ROLLING_OPTIMIZER_WARMUP_CANDLES", 220)
...
ROLLING_OPTIMIZER_MIN_GOOD_MOVES = _get_int("ROLLING_OPTIMIZER_MIN_GOOD_MOVES", 25)
