...
MIN_SIGNAL_STRENGTH_SCORE = 62.0
...
WATCH_BAD_OBSERVATIONS_TO_REMOVE = 4
WATCH_CONFIRMATIONS_REQUIRED = 2

# PIOM / MDW: واچ بالغ، نه خام و نه دیرهنگام
PIOM_MIN_PREMOVE_SCORE = 58.0
MDW_MIN_WATCH_CONFIDENCE = 62.0
DWE_MIN_DIRECTION_FOR_WATCH = 62.0
DWE_INITIAL_GAP = 10.0
...
DWE_LOCK_SCORE = 72.0
DWE_LOCK_GAP = 16.0
DWE_MAX_CONFLICT = 38.0
DWE_PERSISTENCE_REQUIRED = 2
DWE_FAST_LOCK_SCORE = 84.0
DWE_FAST_LOCK_GAP = 25.0

# IWG: شروع حرکت در جهت قفل‌شده، نه بریک‌اوت دیرهنگام
IWG_MIN_IGNITION_SCORE = 72.0
IWG_TRADE_SUPPORT_MIN = 0.08
IWG_BOOK_SUPPORT_MIN = 0.05
IWG_OPPOSITE_MAX = 0.18
...
WATCH_MIN_START_DISPLACEMENT_PCT = 0.025
