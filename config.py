...
PAPER_TRADING_ENABLED = False  # Paper mode disabled; Telegram trading controls use REAL/TOBIT only
...
DAILY_SL_STRICTNESS_START = int(os.getenv('DAILY_SL_STRICTNESS_START', '2'))
