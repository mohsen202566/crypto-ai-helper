...
# -----------------------------
# UEM V2.0 one-hour strategy
# -----------------------------
UEM_MIN_BARS = 40
UEM_WATCH_MIN = 64.0
UEM_ORIGIN_WATCH_MIN = 62.0
UEM_DIRECTION_WATCH_MIN = 58.0
UEM_MIN_GAP_WATCH = 8.0
UEM_FINAL_SIGNAL_MIN = 70.0
UEM_IGNITION_MIN = 72.0
UEM_CONFIRMATIONS_REQUIRED = 2
UEM_MIN_START_RESPONSE_PCT = 0.035
UEM_START_FRACTION = 0.12
UEM_MAX_PULLBACK = 0.52
UEM_STRONG_OPPOSITE = 0.42
UEM_WATCH_OBSERVATIONS = 20
UEM_LATE_MIN_PCT = 0.18
UEM_LATE_MAX_PCT = 1.60
UEM_SL_ATR_MULT = 1.05
