...
FUNDAMENTAL_BLOCK_AFTER_MINUTES = int(os.getenv("FUNDAMENTAL_BLOCK_AFTER_MINUTES", "15"))
...
SESSION_OPEN_HARD_BLOCK_MINUTES = int(os.getenv("SESSION_OPEN_HARD_BLOCK_MINUTES", "10"))
