...
OUTCOME_SL_QUANTILES = (0.45, 0.55, 0.65, 0.75)
OUTCOME_RR_MULTIPLIERS = (1.50, 1.65, 1.85, 2.10)
OUTCOME_MAX_CANDIDATES_PER_HORIZON = 14
OUTCOME_MIN_EXACT_SAMPLES = 18
OUTCOME_MIN_VALID_SAMPLES = 12
# Historical outcome quality is a ranking signal, not a veto.  This is important
# for 15/30-second triggers because the bootstrap history is built from 1m bars.
# Weak history lowers priority, but valid live triggers can still create samples
# for the learner.
OUTCOME_MIN_CONSERVATIVE_WIN_RATE = 0.46
OUTCOME_HISTORY_SOFT_MODE = True
OUTCOME_HISTORY_PENALTY_STRENGTH = 0.90
OUTCOME_HISTORY_BOOST_STRENGTH = 0.20
OUTCOME_NO_HIT_PENALTY = 0.10
OUTCOME_AMBIGUOUS_PENALTY = 0.18
...
LEARNING_FIRST_STEP = 0.04
LEARNING_SECOND_STEP = 0.06
LEARNING_MAX_SIMULTANEOUS_CHANGES = 2
LEARNING_TRIAL_MIN_SAMPLES = 6
LEARNING_TRIAL_MIN_WINS = 3
LEARNING_TRIAL_MAX_SAMPLES = 12
LEARNING_ACCEPT_MIN_WIN_RATE = 0.56
LEARNING_ACCEPT_MIN_EXPECTANCY_USDT = 0.0
LEARNING_ACCEPT_ALLOWED_WINRATE_DROP = 0.015
LEARNING_QUARANTINE_MIN_SAMPLES = 20
LEARNING_QUARANTINE_MAX_WIN_RATE = 0.34
LEARNING_RECOVERY_MIN_SAMPLES = 8
LEARNING_RECOVERY_MIN_WIN_RATE = 0.54
# Learning starts softly and earns authority from live outcomes.  Before enough
# samples, factor misses only reduce plan quality; they do not kill the signal.
LEARNING_FACTOR_FULL_WEIGHT_SAMPLES = 20
LEARNING_HARD_GATE_MIN_SAMPLES = 30
LEARNING_SOFT_MISS_PENALTY = 0.20
LEARNING_QUARANTINE_QUALITY_PENALTY = 0.28
...
LEARNING_FACTOR_BOUNDS = {
    "price_factor": (0.80, 1.30),
    "range_factor": (0.82, 1.35),
    "volume_factor": (0.82, 1.35),
    "directionality_factor": (0.86, 1.30),
    "tp_factor": (0.80, 1.12),
    "sl_factor": (0.90, 1.30),
}
