...
TREND_RSI_BUY_MIN = 52.0
TREND_RSI_SELL_MAX = 48.0
TREND_ADX_MIN = 14.0

ZONE_LONG_RSI_MIN = 52.0
ZONE_LONG_RSI_MAX = 68.0
ZONE_SHORT_RSI_MIN = 32.0
ZONE_SHORT_RSI_MAX = 48.0
ZONE_ADX_MIN = 18.0
ZONE_ADX_MAX = 38.0
ZONE_VWAP_DISTANCE_MIN_PERCENT = 0.10
ZONE_VWAP_DISTANCE_MAX_PERCENT = 0.70
ZONE_VOLUME_MULTIPLIER_MIN = 1.30
ZONE_VOLUME_MULTIPLIER_MAX = 3.50
ZONE_BB_LONG_MAX_POSITION = 0.92
ZONE_BB_SHORT_MIN_POSITION = 0.08
