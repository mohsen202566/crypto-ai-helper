...
ENTRY_POWER2_MIN = 62.0
ENTRY_POWER2_STRONG = 66.0
ENTRY_OPPOSITE_POWER2_MAX = 38.0
ENTRY_POWER_ACCEL_MIN = 3.0
...
def predictive_entry_decision(df_4h, df_1h, df_30m, df_15m, df_5m, price, atr, spread_percent=None):
    ...
    long_ok = (
        ...
        and rsi_rising
        and close_above_ema
        and (close_above_vwap or vwap_reclaim_long)
        and not late_long
        and not strong_context_long_block
    )
    short_ok = (
        ...
        and rsi_falling
        and close_below_ema
        and (close_below_vwap or vwap_reclaim_short)
        and not late_short
        and not strong_context_short_block
    )
